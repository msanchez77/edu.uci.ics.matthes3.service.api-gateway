package edu.uci.ics.matthes3.service.api_gateway;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.matthes3.service.api_gateway.configs.*;
import edu.uci.ics.matthes3.service.api_gateway.connectionpool.ConnectionPool;
...
public class GatewayService {
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.matthes3.service.api_gateway.resources");
