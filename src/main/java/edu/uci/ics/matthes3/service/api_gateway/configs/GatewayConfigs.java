package edu.uci.ics.matthes3.service.api_gateway.configs;
...
public class GatewayConfigs {
    ...
    public GatewayConfigs(ConfigsModel cm) throws NullPointerException {
        if (cm == null) {
            ...
            if (numThreads <= 0) {
                numThreads = 3;
                System.err.println(GatewayService.ANSI_RED + "Number of threads not found in configuration file. Using default." + GatewayService.ANSI_RESET);
            } else {
